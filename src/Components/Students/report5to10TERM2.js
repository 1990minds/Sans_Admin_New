...
const PrintComponent = ({ data, termData }) => {
  ...
  // const fa1Total =
  //   data?.termData?.English?.FA3?.marks +
...
const calculateGradefa1 = (fa1Total, adjustedTotal) => {
  ...
  // const fa2Total =
  //   data?.termData?.English?.FA4?.marks +
  ...
  const subjectsForClasses5to10fa4 = [
    "English",
    "Kannada",
    "Hindi",
    "Mathematics",
  ...
  const validSubjectsCountfa4 = subjectsForClasses5to10fa4.reduce((count, subject) => {
...
const fa4Total = subjectsForClasses5to10fa4.reduce((total, subject) => {
...
// Calculate the adjusted total based on the number of valid subjects
const adjustedTotalfa4 = validSubjectsCountfa4 * 10; 
...
const calculateGradefa4 = (fa4Total, adjustedTotalfa4) => {
  ...
  // const sa1Total =
  //   data?.termData?.English?.SA2?.marks +
  ...
  const subjectsForClasses5to10sa2 = [
    "English",
    "Kannada",
    "Hindi",
    "Mathematics",
  ...
  const validSubjectsCountsa2 = subjectsForClasses5to10sa2.reduce((count, subject) => {
...
const sa2Total = subjectsForClasses5to10sa2.reduce((total, subject) => {
...
// Calculate the adjusted total based on the number of valid subjects
const adjustedTotalsa2 = validSubjectsCountsa2 * 30; 
// Calculate the percentage based on the adjusted total
...
const englishTermTot = (data?.termData?.English?.FA3?.marks === 111 ? 0 : data?.termData?.English?.FA3?.marks) +  (data?.termData?.English?.FA4?.marks === 111 ? 0 : data?.termData?.English?.FA4?.marks) +  (data?.termData?.English?.SA2?.marks === 111 ? 0 :data?.termData?.English?.SA2?.marks)
const englishTermGrade = calculateGradeterm(englishTermTot);

const kannadaTermTot = (data?.termData?.Kannada?.FA3?.marks === 111 ? 0 : data?.termData?.Kannada?.FA3?.marks) + (data?.termData?.Kannada?.FA4?.marks === 111 ? 0 : data?.termData?.Kannada?.FA4?.marks) +  ( data?.termData?.Kannada?.SA2?.marks === 111 ? 0 : data?.termData?.Kannada?.SA2?.marks)
const kannadaTermGrade = calculateGradeterm(kannadaTermTot);

const hindiTermTot = (data?.termData?.Hindi?.FA3?.marks === 111 ? 0 : data?.termData?.Hindi?.FA3?.marks ) +  (data?.termData?.Hindi?.FA4?.marks === 111 ? 0 : data?.termData?.Hindi?.FA4?.marks) +  ( data?.termData?.Hindi?.SA2?.marks === 111 ? 0 : data?.termData?.Hindi?.SA2?.marks)
const hindiTermGrade = calculateGradeterm(hindiTermTot);

const mathTermTot = (data?.termData?.Mathematics?.FA3?.marks === 111 ? 0 : data?.termData?.Mathematics?.FA3?.marks ) +  (data?.termData?.Mathematics?.FA4?.marks === 111 ? 0 : data?.termData?.Mathematics?.FA4?.marks) + ( data?.termData?.Mathematics?.SA2?.marks === 111 ? 0 : data?.termData?.Mathematics?.SA2?.marks)
const mathTermGrade = calculateGradeterm(mathTermTot);

const evsTermTot = (data?.termData?.["E V S / General Science"]?.FA3?.marks === 111 ? 0 : data?.termData?.["E V S / General Science"]?.FA3?.marks ) +  (data?.termData?.["E V S / General Science"]?.FA4?.marks === 111 ? 0 : data?.termData?.["E V S / General Science"]?.FA4?.marks) +  (data?.termData?.["E V S / General Science"]?.SA2?.marks === 111 ? 0 : data?.termData?.["E V S / General Science"]?.SA2?.marks)
const evsTermGrade = calculateGradeterm(evsTermTot);

const socialTermTot = (data?.termData?.["Social Science"]?.FA3?.marks === 111 ? 0 : data?.termData?.["Social Science"]?.FA3?.marks) +  (data?.termData?.["Social Science"]?.FA4?.marks === 111 ? 0 : data?.termData?.["Social Science"]?.FA4?.marks) +  (data?.termData?.["Social Science"]?.SA2?.marks === 111 ? 0 : data?.termData?.["Social Science"]?.SA2?.marks)
                ...
                <tr>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    <div
                      className={`absolute top-0 left-0 bottom-0 ${getScoreColorsub(
                        data?.termData?.English?.FA3?.marks,
                        data?.termData?.English?.FA3?.grade
                      )}`}
                      style={{
                        left: "10%",
                        right: "10%",
                    ...
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.FA3?.marks === 0 ? "NT" : data?.termData?.English?.FA3?.marks === 111 ? "AB" : data?.termData?.English?.FA3?.marks}
                    </span>
                  </td>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    <div
                      className={`absolute top-0 left-0 bottom-0 ${getScoreColorsub(
                        data?.termData?.English?.FA4?.marks,
                        data?.termData?.English?.FA4?.grade
                      )}`}
                      style={{
                        left: "10%",
                        right: "10%",
                    ...
                    ></div>
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.FA4?.marks === 0 ? "NT" : data?.termData?.English?.FA4?.marks === 111 ? "AB" : data?.termData?.English?.FA4?.marks}
                    </span>
                  </td>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    <div
                      className={`absolute top-0 left-0 bottom-0 ${getScoreColorsub(
                        data?.termData?.English?.SA2?.marks,
                        data?.termData?.English?.SA2?.grade
                      )}`}
                      style={{
                        left: "10%",
                        right: "10%",
                    ...
                    ></div>
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.SA2?.marks === 0 ? "NT" : data?.termData?.English?.SA2?.marks === 111 ? "AB" : data?.termData?.English?.SA2?.marks}
                    </span>
                  </td>
