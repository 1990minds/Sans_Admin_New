...
// Calculate the adjusted total based on the number of valid subjects
const adjustedTotalfa4 = validSubjectsCountfa4 * 25; 
...
// Calculate the adjusted total based on the number of valid subjects
const adjustedTotalsa2 = validSubjectsCountsa2 * 50; 
// Calculate the percentage based on the adjusted total
...
const englishTermTot = data?.termData?.English?.FA3?.marks +  data?.termData?.English?.FA4?.marks +  data?.termData?.English?.SA2?.marks
const englishTermGrade = calculateGradeterm(englishTermTot);

const kannadaTermTot = data?.termData?.Kannada?.FA3?.marks +  data?.termData?.Kannada?.FA4?.marks +  data?.termData?.Kannada?.SA2?.marks
const kannadaTermGrade = calculateGradeterm(kannadaTermTot);

const hindiTermTot = data?.termData?.Hindi?.FA3?.marks +  data?.termData?.Hindi?.FA4?.marks +  data?.termData?.Hindi?.SA2?.marks
const hindiTermGrade = calculateGradeterm(hindiTermTot);

const mathTermTot = data?.termData?.Mathematics?.FA3?.marks +  data?.termData?.Mathematics?.FA4?.marks +  data?.termData?.Mathematics?.SA2?.marks
const mathTermGrade = calculateGradeterm(mathTermTot);

const evsTermTot = data?.termData?.["E V S / General Science"]?.FA3?.marks +  data?.termData?.["E V S / General Science"]?.FA4?.marks +  data?.termData?.["E V S / General Science"]?.SA2?.marks
const evsTermGrade = calculateGradeterm(evsTermTot);

const socialTermTot = data?.termData?.["Social Science"]?.FA3?.marks +  data?.termData?.["Social Science"]?.FA4?.marks +  data?.termData?.["Social Science"]?.SA2?.marks
                ...
                <tr>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    ...
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.FA3?.marks === 0 ? "NT" : data?.termData?.English?.FA3?.marks}
                    </span>
                  </td>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    ...
                    ></div>
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.FA4?.marks ===0 ? "NT" : data?.termData?.English?.FA4?.marks}
                    </span>
                  </td>
                  ...
                  <td className="border-2 border-gray-600 text-center relative">
                    ...
                    ></div>
                    <span className="relative z-10 font-bold text-white">
                      { data?.termData?.English?.SA2?.marks ===0 ? "NT" : data?.termData?.English?.SA2?.marks}
                    </span>
                  </td>
